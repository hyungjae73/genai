  ...
  return (
    <div className="customers">
      <div className="page-header">
        <h1>顧客マスター <HelpButton title="このページの使い方">
          <div className="help-content">
            <h3>できること</h3>
            <ul>
              <li>顧客情報の登録・編集・削除</li>
              <li>顧客名・会社名・メールで検索</li>
              <li>有効/無効のステータスフィルタリング</li>
            </ul>

            <h3>操作方法</h3>
            <p>「+ 新規顧客登録」で追加、一覧の「編集」「削除」で変更できます。</p>

            <div className="help-tip">顧客を無効にしても関連サイトの監視は継続されます。無効化は管理状態の変更であり、監視停止ではありません。</div>
          </div>
        </HelpButton></h1>
